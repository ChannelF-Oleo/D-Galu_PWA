...
import { GraduationCap, ArrowRight, Clock, Users, Star, BookOpen } from 'lucide-react';
...
const AcademySection = () => {
  ...
  const getFallbackCourses = () => [
    {
      ...
      description: 'Aprende las técnicas más modernas y tradicionales de trenzado africano con nuestros expertos.',
      duration: '40 horas',
      students: 150,
      rating: 4.9,
      price: 299,
    ...
    },
    {
      ...
      description: 'Domina todas las técnicas de cuidado de uñas, desde lo básico hasta diseños avanzados.',
      duration: '30 horas',
      students: 200,
      rating: 4.8,
      price: 249,
    ...
    },
    {
      ...
      description: 'Conviértete en especialista en tratamientos de spa y técnicas de relajación.',
      duration: '35 horas',
      students: 120,
      rating: 4.9,
      price: 349,
  ...
  const CourseCard = ({ course }) => (
    <div className="course-card bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group">
      <div className="relative overflow-hidden">
        <img
          src={course.image || 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=800&q=80'}
          alt={course.title}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="bg-white rounded-xl p-4 animate-pulse border">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Desarrolla tus habilidades profesionales con nuestros cursos especializados. 
            Aprende de los mejores expertos en belleza y bienestar.
          </p>
        ...
        {courses.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Estamos preparando cursos increíbles para potenciar tu carrera profesional
            </p>
            <button
              onClick={() => navigate('/academy')}
