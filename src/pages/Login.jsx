...
const Login = () => {
  ...
  const { login, loginWithGoogle } = useAuth(); // Extraemos las funciones de login del contexto
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.error("Error en Google Login:", err.code, err.message);
      setError(getErrorMessage(err.code));
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="login-wrapper">
      <form className="login-card glass-card" onSubmit={handleSubmit}>
        ...
        {/* Enlaces adicionales */}
        <div className="login-links" style={{ marginTop: "1rem", textAlign: "center" }}>
          <p style={{ color: "#6b7280", fontSize: "0.9rem", marginBottom: "0.5rem" }}>
            ¿No tienes cuenta?{" "}
            <a 
              href="/register" 
              style={{ color: "#d946ef", textDecoration: "none", fontWeight: "500" }}
